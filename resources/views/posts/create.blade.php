                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('posts.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="body"
                                      rows="6"
                                      class="shadow appearance-none border dark:border-gray-600 rounded w-full py-2 px-3 text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 @error('body') border-red-500 @enderror">{{ old('body') }}</textarea>
                            @error('body')
                                <p class="text-red-500 dark:text-red-400 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
